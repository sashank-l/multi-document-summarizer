# -*- coding: utf-8 -*-
"""multi-document_summarizer.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZOIG829YeIMOkDIcsqJ_RjYRXs4Wfouc
"""

# pip install docx python-pptx Pillow datasets rouge-score beautifulsoup4 pypdf hdbscan numpy seaborn
# pip install gradio torch sentence_transformers transformers nltk scikit-learn matplotlib scipy plotly
# pip install wordcloud pandas openpyxl python-docx
...
def summarize_docs(files_text):
    if files_text:
        ...
        tfidf_fig = tfidf_plot(all_text)
        dendrogram_fig = dendrogram_plot(embeddings, labels)
        tsne_fig = tsne_plot(embeddings, labels)
        wordcloud_fig = wordcloud_plot(all_text)
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        with gr.Column():
            ...
            gr.Markdown(
                "### Supported File Types:  📝 `.txt` 📑 `.pdf` 📊 `.csv` 📈 `.xlsx` 🗂 `.json` 🗃 `.xml` 🎞 `.pptx`",
